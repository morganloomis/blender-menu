...
2. Click **Add Remote Repository** and paste the **full** repository URL (include the repo name — not a personal `github.io` site root):

   `https://morganloomis.github.io/blender-menu/index.json`

   If you added a shorter URL by mistake (for example `https://morganloomis.github.io/`), remove it and use the URL above.
